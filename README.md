...
| v1.1.0 | 🔮 | 闪念笔记 (Fleeting Notes) | fleeting_note 类型 + 快速捕获 + 标签支持 |
| v1.2.0 | 🔮 | 错误日志规范 (Error Logging) | 统一日志 + 错误码 + 日志查看器 |
| v1.3.0 | 🔮 | 项目间通信API | Nigredo ↔ Citrinitas ↔ Rubedo 标准接口 |
| v1.4.0 | 🔮 | 知识关系网 | NetworkX 知识图谱 + 8种关系类型可视化 |
| v1.5.0 | 🔮 | 入库翻译 | 多语言文档自动翻译入库 |
| v1.6.0 | 🔮 | LLM智能选择 | 按任务复杂度自动选择模型 |
| v1.7.0 | 🔮 | 性能优化 | 搜索缓存 + 批量操作 + 冷启动加速 |
...
| v1.1.0 | 🔮 | Fleeting Notes | fleeting_note type + quick capture + tag support |
| v1.2.0 | 🔮 | Error Logging | Unified logging + error codes + log viewer |
...
| v1.5.0 | 🔮 | Ingest Translation | Multi-language doc auto-translation on ingest |
| v1.6.0 | 🔮 | Smart LLM Routing | Auto-select model by task complexity |
| v1.7.0 | 🔮 | Performance Optimization | Search cache + batch ops + cold-start acceleration |
